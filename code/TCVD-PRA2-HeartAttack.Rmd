...
Observamos como **sex, caa, cp, fbs, restecg, exng, slp y thall**  contienen un número limitado de valores únicos, por lo que, probablemente, estén representando variables categóricas. Se comprueba, según la descripción oficial del dataset del punto anterior, que es cada variable y si nuestro análisis inicial es correcto.

Según la descripción oficial, observamos que nuestra suposición es correcta, y que son variables categóricas. Por lo tanto, las convertiremos:
